						...
						<table class="table">
						  <thead class="thead-light">
						    <tr>
						      ...
						      <th scope="col" width="30%">Reviewer Name</th>
						      <th scope="col" width="30%">Published Date</th>
						  ...
						  <tbody>
						    <tr>
						      <th width="10%">01</th>
						      <td width="40%">Natasha Kashyap</td>
						      <td width="40%">22 Aug 2021, 11.30 PM</td>
						      <td width="10%"><a href="edit-manage-community-review.php"><i class="ri-edit-box-line"></i></a></td>
						    </tr>
						    <tr>
						      <th width="10%">01</th>
						      <td width="40%">Natasha Kashyap</td>
