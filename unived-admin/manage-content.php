			...
			<div class="col-xl-10 col-lg-10 col-md-10 col-12 unived-right">
				...
				<div class="row">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-12 text-right add-health-needs">
						<a href="upload-content.php"><button>+ Upload Content</button></a>
					</div>
				</div>
				<div class="row">
						...
						<table class="table">
						  <thead class="thead-light">
						    <tr>
						      ...
						      <th scope="col" width="30%">Content Name</th>
						      <th scope="col" width="30%">Content Type</th>
