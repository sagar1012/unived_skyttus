    ...
    return function(t) {
        ...
        const d = function(t) {
        		let e = document.createElement("div"),
                    ...
                    alldate = t.getFullYear() + "-" + String(t.getMonth() + 1).padStart("2", 0) + "-" + String(t.getDate()).padStart("2", 0);
                a.innerHTML = t.getDate(), e.className = "vanilla-calendar-date", e.setAttribute("data-calendar-date", t), e.setAttribute("data-selectdate", alldate);
