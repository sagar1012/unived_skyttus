...
if( empty($_SESSION['email']) ) {
  ...
  $totalAdminUser = getTotalAdminUsers($conn, $_SESSION['id']);

  // get total user counts.
  $totalUser = getTotalUser($conn);

  // get total products count..
  $totalProduct = getTotalNoOfProducts($conn);

  // get total product category count..
  $totalProductCat = getTotalProductCategory($conn);
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Normal Users</span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $totalProductCat; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
